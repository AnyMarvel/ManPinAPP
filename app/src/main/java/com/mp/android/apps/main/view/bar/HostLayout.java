...
class HostLayout extends RelativeLayout implements Bar {
    ...
    private ShStatusView mStatusView;
    private ShNavigationView mNavigationView;
    ...
    private void loadView() {
        inflate(mActivity, R.layout.view_host_layout, this);
    ...
    public Bar fitsStatusBarView(View view) {
        ...
        if (fitParent != null && !(fitParent instanceof FitWindowLayout)) {
            ...
            ShStatusView statusView = new ShStatusView(mActivity);
    ...
    public Bar fitsNavigationBarView(View view) {
        ...
        if (fitParent != null && !(fitParent instanceof FitWindowLayout)) {
            ...
            ShNavigationView navigationView = new ShNavigationView(mActivity) {
                @Override
