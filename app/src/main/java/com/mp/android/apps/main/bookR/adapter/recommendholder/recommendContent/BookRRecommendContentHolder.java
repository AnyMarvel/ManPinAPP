...
public class BookRRecommendContentHolder extends RecyclerView.ViewHolder {
    ...
    public BookRRecommendContentHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public void handleBookRRecommendContent(Context context, List<SourceListContent> contentList
        ...
        if (contentList.size() > 0 && contentList.get(position) != null) {
