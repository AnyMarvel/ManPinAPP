...
public class ReaderGxwztvBookModelImpl extends MBaseModelImpl implements IReaderBookModel {
    public static final String TAG = "http://www.wzzw.la";

    public static ReaderGxwztvBookModelImpl getInstance() {
        return new ReaderGxwztvBookModelImpl();
    }
