...
public class BookrHotRankingHolder extends RecyclerView.ViewHolder {
    ...
    BookRRecommendListener listener;

    public void handleBookRHotRanking(Context context, List<SourceListContent> hotRankingList, BookRRecommendListener listener) {
