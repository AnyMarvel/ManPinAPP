...
public class ShNavigationView extends View {
    ...
    public ShNavigationView(Context context) {
        this(context, null, 0);
    }

    public ShNavigationView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
