...
import com.mp.android.apps.monke.monkeybook.common.api.TXSAPI;
...
public class TXSBookModelImpl extends MBaseModelImpl implements IReaderBookModel {
    ...
    public Single<ChapterInfoBean> getChapterInfo(String url) {
        return getRetrofitObject(TAG).create(TXSAPI.class).getChapterInfo(url).flatMap(new Function<String, SingleSource<? extends ChapterInfoBean>>() {
            @Override
